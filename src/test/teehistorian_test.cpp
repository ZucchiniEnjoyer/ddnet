...
{
	CNetObj_PlayerInput Input = {1, 2, 3, 4, 5, 6, 0, 7, 8, 9, 10};
	const unsigned char EXPECTED[] = {
		// TICK_SKIP dt=0
		0x41, 0x00,
		// new player -> InputNew
		0x45,
		0x00, // ClientId 0
		0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x00, 0x07, 0x08, 0x09, 0x0a,
		...
		0x45,
		0x00, // ClientId 0
		0x00, 0x02, 0x03, 0x04, 0x05, 0x06, 0x00, 0x07, 0x08, 0x09, 0x0a,
		// FINISH
		0x40};
